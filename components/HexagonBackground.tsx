...
export function HexagonBackground({
  ...
  return (
    <div
      ref={containerRef}
      className={cn("fixed inset-0 overflow-hidden bg-slate-950", className)}
    >
      {/* Hexagon grid */}
            ...
            >
              {Array.from({ length: grid.cols }).map((_, colIndex) => (
                <div
                  ...
                  className={cn(
                    "relative shrink-0 transition-all duration-1000 cursor-pointer",
                    "[clip-path:polygon(50%_0%,100%_25%,100%_75%,50%_100%,0%_75%,0%_25%)]",
                    // Border layer
                    "before:absolute before:inset-0 before:bg-[var(--border-color)]",
                    "before:transition-all before:duration-1000",
                    // Inner fill
                    "after:absolute after:inset-[var(--margin)] after:bg-slate-950",
                    ...
                    "hover:after:bg-slate-900 hover:after:duration-0",
